<div class="chat_filter">
			...
			<div class="chats_uchitel">				
				...
				<div class="left">
					...
					<div class="chats_other_users">
					</div>
					
					<h3>Другие чаты со мной</h3>
					<div class="chats_with_me_manager">
		...
		<div class="right">
			...
			<div class="chats_okno_bottom">
				...
				<p>Чтобы загрузить любой чат, кликните по нему в поле слева, и еще какой-то текст....</p>
			</div>
			<div class="clear"></div>
